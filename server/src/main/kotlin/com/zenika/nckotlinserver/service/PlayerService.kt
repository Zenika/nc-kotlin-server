...
class PlayerService {
    ...
    fun validate(playerId: String, code: Code) = withPlayerScenarioAndState(playerId, { player, scenario, state ->
        ...
        // TODO Créer la variable result en fonction du résultat du step

        // TODO Créer la variable newState en sauvegardant une copie de l'état

        // TODO Décommenter le bloc
